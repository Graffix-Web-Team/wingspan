...
const promotions = [
  ...
  },
  {
    ...
    requirements: [
      ...
      "Lead 3 major community projects",
      "Mentor 6 new participants",
      "Organize community event",
      "Maintain 3.7 GPA or equivalent",
    ],
    benefits: "Platinum Award, $1000 Scholarship, Internship Opportunity",
  },
]
                    ...
                    <div className="flex items-center">
                      <div
                        className={`w-4 h-4 rounded-full mr-3 ${
                          promotion.level === "Bronze"
                            ? "bg-amber-600"
                            : promotion.level === "Silver"
                              ? "bg-gray-400"
