...
const events = [
  {
    ...
    description:
      'Interactive session on developing leadership skills and public speaking.',
  },
  {
    date: 'Dec 22',
    time: '10:00 AM',
    ...
    location: 'Local Park',
    description:
      'Join us for a day of giving back through environmental cleanup and beautification.',
  },
  {
    date: 'Jan 5',
    time: '6:00 PM',
    ...
    description:
      'Meet potential mentors and learn about our mentorship program opportunities.',
  },
  {
    date: 'Jan 12',
    time: '3:00 PM',
    ...
    description:
      'Explore different career paths with professionals from various industries.',
  },
];
