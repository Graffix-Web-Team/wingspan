  ...
  return (
    <section id="overview" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-20">
          <div className="order-2 lg:order-1">
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              and service projects, they will develop their potential and make a positive difference personally, in the
        ...
        <div className="mb-20">
          <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">Learning Outcomes</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Articulate their own leadership philosophy in the context of their multiple identities and values
                  (i.e. school, professional, and community life).
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                <h4 className="text-xl font-semibold text-blue-600 mb-3">2.</h4>
                <p className="text-gray-700">
                  Identify and apply key skills to effectively work with others in academic, professional, and community
                  settings.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <p className="text-gray-700">
                  Identify and demonstrate strategies for how to enact change in various educational, professional, and
        ...
        <div>
          <h3 className="text-2xl font-semibold text-gray-900 mb-6 text-center">
            Students will participate in the Wingspan Leadership Program through these pathways
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            <ul className="list-disc pl-6 space-y-3 text-gray-700 leading-relaxed">
              ...
              <li>
                Participation in trainings available at Cal State LA (Undocually, VetNet Ally, Mental Health First Aid,
                etc.)
              </li>
        ...
        <div className="border-t border-gray-100 pt-8">
          <h4 className="text-xl font-semibold text-gray-900 mb-4">Student Leadership Pathways & Milestones</h4>
          <ul className="space-y-4">
            <li className="flex gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-900">Leadership Engagement</h5>
                <p className="text-gray-700">
                  Participants take on roles that require active commitment and development, including involvement in
                  campus organizations and service initiatives.
                </p>
                <ul className="list-disc pl-6 mt-2 text-gray-700 space-y-1">
                  <li>
                    Opportunities include ASI, U-SU Board, Student Health Advisory Committee, Student Athlete Advisor
                    Committee, Orientation Leader, Tour Guide, Resident Assistants, RHA, Greek Life, and mentorship
                    programs (RISE, Peer Leader Program, etc.).
                  </li>
                  <li>
            ...
            <li className="flex gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-900">Student-Led Innovation</h5>
                <p className="text-gray-700">
                  Encouraged to propose projects, initiatives, or leadership roles aligned with the Social Change Model,
                  participants shape their own development pathways.
                </p>
              </div>
            </li>
            ...
            <li className="flex gap-3">
              ...
              <div>
                <h5 className="font-medium text-gray-900">Milestone Reflection</h5>
                <p className="text-gray-700">
                  Completion of a final project—such as a reflection, essay, or video—demonstrates leadership growth and
                  the impact made.
                </p>
              </div>
            </li>
